...
package cn.herodotus.engine.data.mybatisplus.configuration;

import cn.herodotus.engine.data.core.constants.DataPropertyConstants;
import cn.herodotus.engine.data.mybatisplus.enhance.HerodotusIdentifierGenerator;
...
public class MybatisPlusConfiguration {
    ...
    @Value(DataPropertyConstants.ANNOTATION_SQL_INIT_PLATFORM)
