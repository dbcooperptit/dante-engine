...
public class OAuth2AuthorizationConfiguration extends GlobalMethodSecurityConfiguration {
    ...
    public SecurityMetadataSourceParser securityMetadataSourceParser() {
        SecurityMetadataSourceParser securityMetadataSourceParser = new SecurityMetadataSourceParser(this.getExpressionHandler().getExpressionParser());
    ...
    @Bean
    @ConditionalOnMissingBean
    public RemoteSecurityMetadataSyncListener remoteSecurityMetadataSyncListener(SecurityMetadataSourceAnalyzer securityMetadataProcessService, ServiceMatcher serviceMatcher) {
