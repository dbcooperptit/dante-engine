 ...
 */
public class OAuth2FormLoginWebAuthenticationDetails extends WebAuthenticationDetails {
    ...
    public OAuth2FormLoginWebAuthenticationDetails(HttpServletRequest request, OAuth2UiProperties uiProperties) {
        super(request);
        this.isClosed = uiProperties.getCloseCaptcha();
        this.parameterName = uiProperties.getCaptchaParameter();
        this.category = uiProperties.getCategory();
        this.init(request);
    }
