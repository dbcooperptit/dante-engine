...
package cn.herodotus.engine.oauth2.authorization.ui.authentication;
...
import cn.herodotus.engine.oauth2.authorization.ui.exception.OAuth2CaptchaArgumentIllegalException;
import cn.herodotus.engine.oauth2.authorization.ui.exception.OAuth2CaptchaHasExpiredException;
import cn.herodotus.engine.oauth2.authorization.ui.exception.OAuth2CaptchaIsEmptyException;
import cn.herodotus.engine.oauth2.authorization.ui.exception.OAuth2CaptchaMismatchException;
...
public class OAuth2FormLoginAuthenticationProvider extends DaoAuthenticationProvider {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails, UsernamePasswordAuthenticationToken authentication) throws AuthenticationException {
        ...
        if (ObjectUtils.isNotEmpty(details) && details instanceof OAuth2FormLoginWebAuthenticationDetails) {
            OAuth2FormLoginWebAuthenticationDetails formLoginWebAuthenticationDetails = (OAuth2FormLoginWebAuthenticationDetails) details;

            if (!formLoginWebAuthenticationDetails.isClosed()) {
