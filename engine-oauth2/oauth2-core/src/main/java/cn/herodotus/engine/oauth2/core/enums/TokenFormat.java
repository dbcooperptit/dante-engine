...
public enum TokenFormat {
    ...
    TokenFormat(String method, String description) {
        this.format = method;
    ...
    public static TokenFormat getTokenFormat(Integer grant) {
