...
public class OAuth2DataJpaModuleConfiguration {

    private static final Logger log = LoggerFactory.getLogger(OAuth2DataJpaModuleConfiguration.class);

    @PostConstruct
    public void postConstruct() {
        log.debug("[Herodotus] |- SDK [Engine OAuth2 Data JPA] Auto Configure.");
    }
