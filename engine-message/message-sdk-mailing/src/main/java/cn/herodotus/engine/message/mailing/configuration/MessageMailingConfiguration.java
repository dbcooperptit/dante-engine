...
@EntityScan(basePackages = {
        "cn.herodotus.engine.message.mailing.entity"
})
@EnableJpaRepositories(basePackages = {
        "cn.herodotus.engine.message.mailing.repository",
})
@ComponentScan(basePackages = {
        "cn.herodotus.engine.message.mailing.service",
        "cn.herodotus.engine.message.mailing.controller",
})
