...
public interface TemporalConstants extends BaseConstants {
    ...
    String ITEM_INFLUXDB_USERNAME = PROPERTY_TEMPORAL_INFLUXDB + ".username";
    String ITEM_INFLUXDB_PASSWORD = PROPERTY_TEMPORAL_INFLUXDB + ".password";
}
