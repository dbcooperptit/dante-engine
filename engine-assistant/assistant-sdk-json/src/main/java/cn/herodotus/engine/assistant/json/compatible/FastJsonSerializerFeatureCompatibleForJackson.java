...
package cn.herodotus.engine.assistant.json.compatible;

import cn.herodotus.engine.assistant.json.compatible.SerializerFeature;
...
public class FastJsonSerializerFeatureCompatibleForJackson extends BeanSerializerModifier {
    ...
    public FastJsonSerializerFeatureCompatibleForJackson(SerializerFeature... features) {
        ...
        nullListJsonSerializer = (config & SerializerFeature.WriteNullListAsEmpty.mask) != 0 ? new NullListSerializer() : null;
