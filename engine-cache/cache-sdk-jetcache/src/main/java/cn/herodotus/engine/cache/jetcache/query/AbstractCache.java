 ...
 * @date : 2020/6/3 10:09
 */
public abstract class AbstractCache<E extends AbstractCacheEntity> {
     ...
     *
     * @param cacheName 实体标识 {@link AbstractCacheEntity#getId()}
     * @return 缓存的实体
     */
     ...
     * 通过映射实体属性获取实体
     *
     * @param domainLinkProperty 映射属性{@link AbstractCacheEntity#getLinkedProperty()}
     * @return 实体
     */
